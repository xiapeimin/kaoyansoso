...
export default class Resource extends Component {
    ...
    componentDidMount(){
        ...
        if(type=='share'){
            this.setState({
                type:type,
                todo:[
                    <div style={{background:'#fff',paddingBottom:'35px',lineHeight:'28px'}}>
                         <NavBar               
                style={{backgroundColor:'#66cccc',color:'white'}}>
                  ...
                  <span style={{color:'white',fontSize:'21px'}}>经验分享</span>           
                </NavBar>
                {/* <img style={{position:"absolute",width:'100%',height:'600vw',opacity:'0.2'}} src={require('../imgs/pen.jpg')}/> */}
                <div style={{fontSize:'4.5vw',width:'90%',left:'5%',
                position:'relative',textIndent:'2em',top:'5vw'}}>
                    <div style={{fontWeight:'bold',fontSize:'6vw'}}>考研经验分享</div>
                <br/>
                <div className='zxtit1'>
                    ...
                    <div style={{textIndent:'2em'}}>本人本科是双非一本，19年考研很幸运能够一战上岸，顺利考取某211高校。</div>
                <br/>
                <div style={{textIndent:'2em'}}>很荣幸有机会分享我的考研经历，考虑到每个人的情况不尽相同，所以接下来我分享的经验都是仅供大家参考，
                切不可生搬硬套，我只能保证下面这些话都是我的切身感受、亲身经历。</div>
                <br/>
                <img src={require('../imgs/ziyuan1.jpg')} style={{width:'100%'}} />
    ...
    我的学习经历大概就是这样，有些时间节点或者经历可能有所偏差，建议大家结合自身情况制定学习计划，不要怕慢不要怕不会，按部就班就一定能成功。
            ...
            <div style={{background:'#fff',paddingBottom:'35px',lineHeight:'28px'}}>
                ...
                style={{backgroundColor:'#66cccc',color:'white'}}>
                  ...
                  <span style={{color:'white',fontSize:'21px'}}>考研文本资料</span>           
                </NavBar>
                {/* <img style={{position:"absolute",width:'100%',height:'450vw',opacity:'0.2'}} src={require('../imgs/jingyan.jpg')}/> */}
                <div style={{fontSize:'4.5vw',backgroundImage:'../imgs/music.jpg',width:'90%',left:'5%',
                position:'relative',textIndent:'2em',top:'5vw'}}>
                
                <div style={{fontWeight:'bold',fontSize:'6vw'}}>如何准备考研资料？</div>
                <br/>
                <div className='zxtit1'>
                        <img src={require('../imgs/time.png')}/>
                        <span>{this.state.time}</span>
                ...
                <br/>
                <img src={require('../imgs/ziyuan2.jpg')} style={{width:'100%'}} />
                <br/>
    ...
    <br/>
    <div style={{textIndent:'2em'}}>1.先把基础的书，过一遍，整理个框架。对教育学的大概知识框架，有一个了解。</div>
<br/>
<div style={{textIndent:'2em'}}>2.知识点一定要用自己的话去复述！这样你才能去理解那些比较拗口的理论。</div>
<br/>
<div style={{textIndent:'2em'}}>3.英语大三上学期开始，可以先记考研词汇。真题其实不用太着急，先把词汇过一遍，对之后的真题练习很有帮助！</div>
<br/>
...
<div style={{textIndent:'2em'}}>背单词可以用闪过英语《考研词汇闪过》，书中把考研大纲词汇按重要程度分成了必考词、基础词、偶考词、超纲词。你刚开始可以把书先过一遍，本来考研词汇就是需要每天都背诵，这样才不会遗忘。</div>
            ...
            <div>
                         <NavBar               
                style={{backgroundColor:'#66cccc',color:'white',lineHeight:'28px'}}>
                   <Link to={`/searchinfo?uid=${uid}`}>
                      <Icon type={'left'} style={{position:'absolute',top:'10px',left:'4%',color:'white'}}/>
                   </Link>
                  <span style={{color:'white',fontSize:'21px'}}>音视频</span>           
                </NavBar>
            ...
            <div style={{background:'#fff',paddingBottom:'35px',lineHeight:'28px'}}>
                ...
                style={{backgroundColor:'#66cccc',color:'white'}}>
                  ...
                  <span style={{color:'white',fontSize:'21px'}}>老梁考研汇</span>           
                </NavBar>
                {/* <img style={{position:"absolute",width:'100%',height:'450vw',opacity:'0.2'}} src={require('../imgs/laoliang.jpg')}/> */}
                <div style={{fontSize:'4.5vw',backgroundImage:'../imgs/music.jpg',width:'90%',left:'5%',
                position:'relative',textIndent:'2em',top:'5vw'}}>
                    <div style={{fontWeight:'bold',fontSize:'6vw'}}>其实你问考研有什么好处，改变大不大，这谁能回答？</div>
                <br/>
                <div className='zxtit1'>
                        <img src={require('../imgs/time.png')}/>
                        <span>{this.state.time}</span>
                ...
                <br/>
                <img src={require('../imgs/ziyuan3.jpg')} style={{width:'100%',height:'50vw'}} />
                <div style={{textIndent:'2em'}}>
...
所以成熟的行业需要高精尖的东西，考研是没问题的，但是方兴未艾的新产业就不要去了，在学校里耽误那些无用功也没必要。从小学初中高中大学算算自己念了多少年书？还回学校念？人生的光阴不要都泡到学校里，社会这所大学，对于我们每个人来说，同样用处很大。
            ...
            <div style={{background:'#fff',paddingBottom:'35px',lineHeight:'28px'}}>
                ...
                style={{backgroundColor:'#66cccc',color:'white'}}>
                  ...
                  <span style={{color:'white',fontSize:'21px'}}>雪峰说考研</span>           
                </NavBar>
                {/* <img style={{position:"absolute",width:'100%',height:'500vw',opacity:'0.2'}} src={require('../imgs/xuefeng.jpg')}/> */}
                <div style={{fontSize:'4.5vw',backgroundImage:'../imgs/music.jpg',width:'90%',left:'5%',
                position:'relative',textIndent:'2em',top:'5vw'}}>
                <div style={{fontWeight:'bold',fontSize:'6vw'}}>张雪峰深情演讲：大学生为什么要努力考研看完之后默默努力</div>
                <br/>
                <div className='zxtit1'>
                        <img src={require('../imgs/time.png')}/>
                        <span>{this.state.time}</span>
                ...
                <div style={{textIndent:'2em'}}>中国存在一个争论不休的话题，很多人都在争论，学历到底重不重要？很多在表面上说学历不重要的人，心底却在默默努力。这个世界什么最重要？当然是能力，可是怎么才能展示出你的能力呢？这就要通过学历去打通自己展示能力的道路。</div>
                <br/>
                <img src={require('../imgs/ziyuan5.jpg')} style={{width:'100%'}} />
                <div style={{textIndent:'2em'}}>
