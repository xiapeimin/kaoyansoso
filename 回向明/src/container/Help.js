...
import { Accordion, List,NoticeBar, WhiteSpace} from 'antd-mobile';
        ...
        return (
            <div className='testbox'>
                ...
                <div style={{backgroundColor:'white',height:'50px'
                    ...
                    ,marginTop:'2px'}}>
                    <img  src={helph} alt="" style={{width:'40px',height:'40px',float:'left',paddingTop:'5px',marginLeft:'10px',marginRight:'5px'}}></img>
                    <h2 style={{lineHeight:'50px',margin:'0'}}>常见问题</h2>
                </div>
                <div>
                    <Accordion defaultActiveKey="0" className="my-accordion" onChange={this.onChange}>
                    <img  src={help} alt="" style={{width:'35px',height:'35px',float:'left',marginTop:'8px',marginLeft:'12px'}}></img>
                    <Accordion.Panel 
                        header="如何修改目标研校/专业?"
                ...
                <NoticeBar marqueeProps={{ loop: true, style: { padding: '0 7.5px' } }}>
                    hi~ 我是史上最萌机器人SoSo，你有什么问题可以直接问我哦~ 我们一起来聊天吧！
                </NoticeBar>

                <div style={{height:'26vw'}}></div>
                <Link to={`/contact?uid=${uid}`}><img src={require('../imgs/robote.gif')} style={{width:'50vw',height:'50vw',marginBottom:'8vw',marginLeft:'25%'}} /></Link>

                <Link to={`/publish?uid=${uid}`}>
                    <div style={{position:'fixed',bottom:'0',width:'100%',lineHeight:'12vw',height:'12vw',backgroundColor:'#FF8888',color:'white',fontSize:'5vw',textAlign:'center'}}>发表反馈</div>
                </Link>
            </div>
        )
    }
