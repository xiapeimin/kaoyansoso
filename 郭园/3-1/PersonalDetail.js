        ...
        fetch(`http://xpm.xpmwqhzygy.top/headlist`,{
            ...
            .then((res)=>{
                ...
                for(var i=0;i<data.length;i++){
                    if(pickid==data[i].pickid){
                        this.setState({
                            headimg2:`http://xpm.xpmwqhzygy.top/head/${pickid}`,
                            pre:1
                        });
                        i=data.length;
                    }else if(i==data.length-1 && pickid != data[i].pickid){
                        this.setState({
                            pre:0
                        })
                    }
            ...
            <div style={{background:'#fff',width:'100%',position:'absolute',top:'0',bottom:'0'}}>
                ...
                <div style={{
                    ...
                    style={{
                        ...
                        width:'70vw'}}>昵称：</span>
                    <p style={{fontSize:'4vw',lineHeight:'20vw',paddingRight:'5vw'}}>{this.state.username}</p>
                </div>
                <div style={{backgroundColor:'white',height:'20vw',borderBottom:'1vw solid #DDDDDD'}}>
                    ...
                    style={{
                        ...
                        marginBottom:'0',float:'left',
                        width:'60vw'}}>考研宣言：</span>
                    <p style={{fontSize:'4vw',lineHeight:'20vw',float:'right',paddingRight:'10vw'}}>{this.state.text}</p>
                </div>
                <p style={{
                    lineHeight:'20vw',marginLeft:'5vw',
                    fontSize:'5vw',marginTop:'0',
