    ...
    render(){
        return(
            <div style={{width:'100%',position:'absolute',top:'0',bottom:'0'}}>
                ...
                <Link to={'/checkSchool'}><div style={{width:'50%',height:'25vw',background:'#30ef8a',position:'absolute',left:'25%',top:'60vw',borderRadius:'2vw',textAlign:'center',lineHeight:'25vw',fontSize:'8vw',color:'#fff'}}>院校推荐</div></Link>
                <Link to={'/checkPro'}><div style={{width:'50%',height:'25vw',background:'#3fc5f1',position:'absolute',left:'25%',top:'95vw',borderRadius:'2vw',textAlign:'center',lineHeight:'25vw',fontSize:'8vw',color:'#fff'}}>专业推荐</div></Link>
